...
/* test/.libs/lt-test-fdleak.c - temporary wrapper executable for .libs/test-fdleak.exe
...
const char * TARGET_PROGRAM_NAME = "test-fdleak.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# test/test-fdleak - temporary wrapper script for .libs/test-fdleak.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The test/test-fdleak program cannot be directly executed until all the libtoo", f);
  fputs ("l\n", f);
  ...
  fputs ("    echo \"test-fdleak.exe:test/test-fdleak:${LINENO}: libtool wrapper (GNU libt", f);
  fputs ("ool) 2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test-fdleak.exe:test/test-fdleak:${LINENO}: newargv[$lt_dump_args_N]", f);
  fputs (": $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test-fdleak.exe:test/test-fdleak:${LINENO}: newargv[0]: $progdir", f);
  fputs ("/$program\" 1>&2\n", f);
