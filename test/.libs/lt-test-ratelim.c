...
/* test/.libs/lt-test-ratelim.c - temporary wrapper executable for .libs/test-ratelim.exe
...
const char * TARGET_PROGRAM_NAME = "test-ratelim.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# test/test-ratelim - temporary wrapper script for .libs/test-ratelim.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The test/test-ratelim program cannot be directly executed until all the libto", f);
  fputs ("ol\n", f);
  ...
  fputs ("    echo \"test-ratelim.exe:test/test-ratelim:${LINENO}: libtool wrapper (GNU li", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test-ratelim.exe:test/test-ratelim:${LINENO}: newargv[$lt_dump_args_", f);
  fputs ("N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test-ratelim.exe:test/test-ratelim:${LINENO}: newargv[0]: $progd", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test-ratelim.exe'\n", f);
