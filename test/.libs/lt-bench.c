...
/* test/.libs/lt-bench.c - temporary wrapper executable for .libs/bench.exe
...
const char * TARGET_PROGRAM_NAME = "bench.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# test/bench - temporary wrapper script for .libs/bench.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The test/bench program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"bench.exe:test/bench:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\" ", f);
  fputs ("1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"bench.exe:test/bench:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"bench.exe:test/bench:${LINENO}: newargv[0]: $progdir/$program\" 1", f);
  fputs (">&2\n", f);
