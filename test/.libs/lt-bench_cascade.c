...
/* test/.libs/lt-bench_cascade.c - temporary wrapper executable for .libs/bench_cascade.exe
...
const char * TARGET_PROGRAM_NAME = "bench_cascade.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# test/bench_cascade - temporary wrapper script for .libs/bench_cascade.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The test/bench_cascade program cannot be directly executed until all the libt", f);
  fputs ("ool\n", f);
  ...
  fputs ("    echo \"bench_cascade.exe:test/bench_cascade:${LINENO}: libtool wrapper (GNU ", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"bench_cascade.exe:test/bench_cascade:${LINENO}: newargv[$lt_dump_arg", f);
  fputs ("s_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"bench_cascade.exe:test/bench_cascade:${LINENO}: newargv[0]: $pro", f);
  ...
  fputs ("\n", f);
  fputs ("  program='bench_cascade.exe'\n", f);
