...
/* sample/.libs/lt-event-read-fifo.c - temporary wrapper executable for .libs/event-read-fifo.exe
   Generated by libtool (GNU libtool) 2.4.2

   The sample/event-read-fifo program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "c:\\temporary\\libevent-mingw32\\libevent-mingw32\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "\\c\\temporary\\libevent-mingw32\\libevent-mingw32\\.libs:C:\\temporary\\libevent-mingw32\\inst_temp\\Win32\\lib:C:\\temporary\\libevent-mingw32\\inst_temp\\Win32\\bin;";
const char * TARGET_PROGRAM_NAME = "event-read-fifo.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# sample/event-read-fifo - temporary wrapper script for .libs/event-read-fifo.e", f);
  fputs ("xe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The sample/event-read-fifo program cannot be directly executed until all the ", f);
  fputs ("libtool\n", f);
  ...
  fputs ("    echo \"event-read-fifo.exe:sample/event-read-fifo:${LINENO}: libtool wrapper", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"event-read-fifo.exe:sample/event-read-fifo:${LINENO}: newargv[$lt_du", f);
  fputs ("mp_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"event-read-fifo.exe:sample/event-read-fifo:${LINENO}: newargv[0]", f);
  ...
  fputs ("\n", f);
  fputs ("  program='event-read-fifo.exe'\n", f);
  ...
  fputs ("    PATH=/c/temporary/libevent-mingw32/libevent-mingw32/.libs:C:/temporary/libe", f);
  fputs ("vent-mingw32/inst_temp/Win32/lib:C:/temporary/libevent-mingw32/inst_temp/Win32/", f);
  fputs ("bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/c/temporary/libevent-mingw32/libevent-mingw32/.libs:$PATH\"\n", f);
  fputs ("\n", f);
