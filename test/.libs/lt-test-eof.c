...
/* test/.libs/lt-test-eof.c - temporary wrapper executable for .libs/test-eof.exe
...
const char * TARGET_PROGRAM_NAME = "test-eof.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# test/test-eof - temporary wrapper script for .libs/test-eof.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The test/test-eof program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"test-eof.exe:test/test-eof:${LINENO}: libtool wrapper (GNU libtool) 2", f);
  fputs (".4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test-eof.exe:test/test-eof:${LINENO}: newargv[$lt_dump_args_N]: $lt_", f);
  fputs ("arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test-eof.exe:test/test-eof:${LINENO}: newargv[0]: $progdir/$prog", f);
  fputs ("ram\" 1>&2\n", f);
