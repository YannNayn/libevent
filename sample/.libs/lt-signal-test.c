...
/* sample/.libs/lt-signal-test.c - temporary wrapper executable for .libs/signal-test.exe
   Generated by libtool (GNU libtool) 2.4.2

   The sample/signal-test program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "signal-test.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# sample/signal-test - temporary wrapper script for .libs/signal-test.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The sample/signal-test program cannot be directly executed until all the libt", f);
  fputs ("ool\n", f);
  ...
  fputs ("    echo \"signal-test.exe:sample/signal-test:${LINENO}: libtool wrapper (GNU li", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"signal-test.exe:sample/signal-test:${LINENO}: newargv[$lt_dump_args_", f);
  fputs ("N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"signal-test.exe:sample/signal-test:${LINENO}: newargv[0]: $progd", f);
