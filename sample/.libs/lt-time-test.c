...
/* sample/.libs/lt-time-test.c - temporary wrapper executable for .libs/time-test.exe
   Generated by libtool (GNU libtool) 2.4.2

   The sample/time-test program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "time-test.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# sample/time-test - temporary wrapper script for .libs/time-test.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The sample/time-test program cannot be directly executed until all the libtoo", f);
  fputs ("l\n", f);
  ...
  fputs ("    echo \"time-test.exe:sample/time-test:${LINENO}: libtool wrapper (GNU libtoo", f);
  fputs ("l) 2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"time-test.exe:sample/time-test:${LINENO}: newargv[$lt_dump_args_N]: ", f);
  fputs ("$lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"time-test.exe:sample/time-test:${LINENO}: newargv[0]: $progdir/$", f);
  fputs ("program\" 1>&2\n", f);
