...
/* sample/.libs/lt-hello-world.c - temporary wrapper executable for .libs/hello-world.exe
   Generated by libtool (GNU libtool) 2.4.2

   The sample/hello-world program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "hello-world.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# sample/hello-world - temporary wrapper script for .libs/hello-world.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The sample/hello-world program cannot be directly executed until all the libt", f);
  fputs ("ool\n", f);
  ...
  fputs ("    echo \"hello-world.exe:sample/hello-world:${LINENO}: libtool wrapper (GNU li", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"hello-world.exe:sample/hello-world:${LINENO}: newargv[$lt_dump_args_", f);
  fputs ("N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"hello-world.exe:sample/hello-world:${LINENO}: newargv[0]: $progd", f);
