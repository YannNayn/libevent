...
/* test/.libs/lt-test-init.c - temporary wrapper executable for .libs/test-init.exe
...
const char * TARGET_PROGRAM_NAME = "test-init.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# test/test-init - temporary wrapper script for .libs/test-init.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The test/test-init program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"test-init.exe:test/test-init:${LINENO}: libtool wrapper (GNU libtool)", f);
  fputs (" 2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test-init.exe:test/test-init:${LINENO}: newargv[$lt_dump_args_N]: $l", f);
  fputs ("t_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test-init.exe:test/test-init:${LINENO}: newargv[0]: $progdir/$pr", f);
  fputs ("ogram\" 1>&2\n", f);
