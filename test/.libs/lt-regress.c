...
/* test/.libs/lt-regress.c - temporary wrapper executable for .libs/regress.exe
...
const char * TARGET_PROGRAM_NAME = "regress.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# test/regress - temporary wrapper script for .libs/regress.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The test/regress program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"regress.exe:test/regress:${LINENO}: libtool wrapper (GNU libtool) 2.4", f);
  fputs (".2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"regress.exe:test/regress:${LINENO}: newargv[$lt_dump_args_N]: $lt_ar", f);
  fputs ("g\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"regress.exe:test/regress:${LINENO}: newargv[0]: $progdir/$progra", f);
  fputs ("m\" 1>&2\n", f);
