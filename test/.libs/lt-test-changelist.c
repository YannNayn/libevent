...
/* test/.libs/lt-test-changelist.c - temporary wrapper executable for .libs/test-changelist.exe
...
const char * TARGET_PROGRAM_NAME = "test-changelist.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# test/test-changelist - temporary wrapper script for .libs/test-changelist.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The test/test-changelist program cannot be directly executed until all the li", f);
  fputs ("btool\n", f);
  ...
  fputs ("    echo \"test-changelist.exe:test/test-changelist:${LINENO}: libtool wrapper (", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test-changelist.exe:test/test-changelist:${LINENO}: newargv[$lt_dump", f);
  fputs ("_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test-changelist.exe:test/test-changelist:${LINENO}: newargv[0]: ", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test-changelist.exe'\n", f);
