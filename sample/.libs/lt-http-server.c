...
/* sample/.libs/lt-http-server.c - temporary wrapper executable for .libs/http-server.exe
   Generated by libtool (GNU libtool) 2.4.2

   The sample/http-server program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "http-server.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# sample/http-server - temporary wrapper script for .libs/http-server.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The sample/http-server program cannot be directly executed until all the libt", f);
  fputs ("ool\n", f);
  ...
  fputs ("    echo \"http-server.exe:sample/http-server:${LINENO}: libtool wrapper (GNU li", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"http-server.exe:sample/http-server:${LINENO}: newargv[$lt_dump_args_", f);
  fputs ("N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"http-server.exe:sample/http-server:${LINENO}: newargv[0]: $progd", f);
