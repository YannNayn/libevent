...
/* test/.libs/lt-bench_httpclient.c - temporary wrapper executable for .libs/bench_httpclient.exe
...
const char * TARGET_PROGRAM_NAME = "bench_httpclient.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# test/bench_httpclient - temporary wrapper script for .libs/bench_httpclient.e", f);
  fputs ("xe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The test/bench_httpclient program cannot be directly executed until all the l", f);
  fputs ("ibtool\n", f);
  ...
  fputs ("    echo \"bench_httpclient.exe:test/bench_httpclient:${LINENO}: libtool wrapper", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"bench_httpclient.exe:test/bench_httpclient:${LINENO}: newargv[$lt_du", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"bench_httpclient.exe:test/bench_httpclient:${LINENO}: newargv[0]", f);
  ...
  fputs ("\n", f);
  fputs ("  program='bench_httpclient.exe'\n", f);
