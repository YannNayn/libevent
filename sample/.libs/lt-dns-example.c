...
/* sample/.libs/lt-dns-example.c - temporary wrapper executable for .libs/dns-example.exe
   Generated by libtool (GNU libtool) 2.4.2

   The sample/dns-example program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "dns-example.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# sample/dns-example - temporary wrapper script for .libs/dns-example.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The sample/dns-example program cannot be directly executed until all the libt", f);
  fputs ("ool\n", f);
  ...
  fputs ("    echo \"dns-example.exe:sample/dns-example:${LINENO}: libtool wrapper (GNU li", f);
  fputs ("btool) 2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"dns-example.exe:sample/dns-example:${LINENO}: newargv[$lt_dump_args_", f);
  fputs ("N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"dns-example.exe:sample/dns-example:${LINENO}: newargv[0]: $progd", f);
  fputs ("ir/$program\" 1>&2\n", f);
