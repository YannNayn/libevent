...
/* test/.libs/lt-test-dumpevents.c - temporary wrapper executable for .libs/test-dumpevents.exe
...
const char * TARGET_PROGRAM_NAME = "test-dumpevents.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# test/test-dumpevents - temporary wrapper script for .libs/test-dumpevents.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The test/test-dumpevents program cannot be directly executed until all the li", f);
  fputs ("btool\n", f);
  ...
  fputs ("    echo \"test-dumpevents.exe:test/test-dumpevents:${LINENO}: libtool wrapper (", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test-dumpevents.exe:test/test-dumpevents:${LINENO}: newargv[$lt_dump", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test-dumpevents.exe:test/test-dumpevents:${LINENO}: newargv[0]: ", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test-dumpevents.exe'\n", f);
