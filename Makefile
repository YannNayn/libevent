...
DIST_COMMON = README $(am__configure_deps) \
	...
	compile config.guess config.sub depcomp epoll_sub.c install-sh \
	ltmain.sh missing
...
am__append_8 = $(TESTPROGRAMS)
am__append_9 = test/regress
am__append_10 = test/regress.gen.c test/regress.gen.h
#am__append_11 = libevent_pthreads.la
am__append_12 = test/regress_iocp.c
#am__append_13 = test/regress_ssl.c
#am__append_14 = $(OPENSSL_INCS)
#am__append_15 = libevent_openssl.la $(OPENSSL_LIBS) ${OPENSSL_LIBADD}
am__append_16 = strlcpy.c
#am__append_17 = select.c
#am__append_18 = poll.c
#am__append_19 = devpoll.c
#am__append_20 = kqueue.c
#am__append_21 = epoll.c
#am__append_22 = evport.c
am__append_23 = signal.c
#am__append_24 = $(EVENT1_HDRS)
subdir = .
...
#am__objects_9 = $(am__objects_1) $(am__objects_2) \
#	$(am__objects_3) $(am__objects_4) \
#	$(am__objects_5) $(am__objects_6) \
#	$(am__objects_7) $(am__objects_8)
am__objects_9 = win32select.lo evthread_win32.lo \
...
am__EXEEXT_4 = test/bench$(EXEEXT) test/bench_cascade$(EXEEXT) \
	...
	test/test-eof$(EXEEXT) test/test-fdleak$(EXEEXT) \
	test/test-init$(EXEEXT) test/test-ratelim$(EXEEXT) \
	test/test-time$(EXEEXT) test/test-weof$(EXEEXT) \
	test/regress$(EXEEXT)
...
##am__objects_12 = test/test_regress-regress_thread.$(OBJEXT)
am__objects_12 =  \
	test/test_regress-regress_thread.$(OBJEXT)
#am__objects_13 =  \
...
am__noinst_HEADERS_DIST = include/event2/buffer.h \
	...
	time-internal.h util-internal.h include/evdns.h \
...
ACLOCAL = ${SHELL} /c/temporary/libevent-mingw32/libevent-mingw32/missing --run aclocal-1.12
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /c/temporary/libevent-mingw32/libevent-mingw32/missing --run autoconf
AUTOHEADER = ${SHELL} /c/temporary/libevent-mingw32/libevent-mingw32/missing --run autoheader
AUTOMAKE = ${SHELL} /c/temporary/libevent-mingw32/libevent-mingw32/missing --run automake-1.12
AWK = gawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2 -Wall -fno-strict-aliasing -W -Wfloat-equal -Wundef -Wpointer-arith -Wstrict-prototypes -Wmissing-prototypes -Wwrite-strings -Wredundant-decls -Wchar-subscripts -Wcomment -Wformat -Wwrite-strings -Wmissing-declarations -Wredundant-decls -Wnested-externs -Wbad-function-cast -Wswitch-enum -Wno-unused-parameter -Wstrict-aliasing -Winit-self -Wmissing-field-initializers -Wdeclaration-after-statement -Waddress -Wnormalized=id -Woverride-init -Wlogical-op
CPP = gcc -E
CPPFLAGS = 
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
...
LD = i:/m/mingw/mingw32/bin/ld.exe
LDFLAGS = 
...
LN_S = cp -pR
LTLIBOBJS = 
MAKEINFO = ${SHELL} /c/temporary/libevent-mingw32/libevent-mingw32/missing --run makeinfo
MANIFEST_TOOL = mt
MKDIR_P = /bin/mkdir -p
NM = /mingw/bin/nm
NMEDIT = 
...
PACKAGE_STRING = libevent 2.1.3-alpha
PACKAGE_TARNAME = libevent
PACKAGE_URL = 
PACKAGE_VERSION = 2.1.3-alpha
PATH_SEPARATOR = :
PKG_CONFIG = 
PTHREAD_CC = 
PTHREAD_CFLAGS = 
PTHREAD_LIBS =  $(am__append_11)
RANLIB = ranlib
SED = /bin/sed
SET_MAKE = 
SHELL = /bin/sh
...
VERSION = 2.1.3-alpha
ZLIB_LIBS = 
abs_builddir = /c/temporary/libevent-mingw32/libevent-mingw32
abs_srcdir = /c/temporary/libevent-mingw32/libevent-mingw32
abs_top_builddir = /c/temporary/libevent-mingw32/libevent-mingw32
abs_top_srcdir = /c/temporary/libevent-mingw32/libevent-mingw32
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
acx_pthread_config = 
...
install_sh = ${SHELL} /c/temporary/libevent-mingw32/libevent-mingw32/install-sh
...
pdfdir = ${docdir}
prefix = C:/temporary/libevent-mingw32/inst_temp/Win32
...
DISTCLEANFILES = test/test-script.sh *~ libevent.pc \
...
#SYS_SRC = $(am__append_16) $(am__append_17) \
...
SYS_SRC = win32select.c evthread_win32.c \
	...
	bufferevent_async.c $(am__append_16) \
...
$(srcdir)/include/include.am $(srcdir)/sample/include.am $(srcdir)/test/include.am:
...
TAGS:  $(HEADERS) $(SOURCES) config.h.in evconfig-private.h.in $(TAGS_DEPENDENCIES) \
		$(TAGS_FILES) $(LISP)
	set x; \
	here=`pwd`; \
	list='$(SOURCES) $(HEADERS) config.h.in evconfig-private.h.in $(LISP) $(TAGS_FILES)'; \
	unique=`for i in $$list; do \
	    if test -f "$$i"; then echo $$i; else echo $(srcdir)/$$i; fi; \
	  done | \
	  $(AWK) '{ files[$$0] = 1; nonempty = 1; } \
...
ctags: CTAGS
CTAGS:  $(HEADERS) $(SOURCES) config.h.in evconfig-private.h.in $(TAGS_DEPENDENCIES) \
		$(TAGS_FILES) $(LISP)
	list='$(SOURCES) $(HEADERS) config.h.in evconfig-private.h.in $(LISP) $(TAGS_FILES)'; \
	unique=`for i in $$list; do \
	    if test -f "$$i"; then echo $$i; else echo $(srcdir)/$$i; fi; \
...
.PHONY: CTAGS GTAGS all all-am am--refresh check check-TESTS check-am \
	clean clean-cscope clean-generic clean-libLTLIBRARIES \
